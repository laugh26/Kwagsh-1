...
int main(int argc, char* argv[])
{
  ...
  try {
    ...
    logger(Logging::INFO, BRIGHT_GREEN) << "    | |                                        " << ENDL;
    logger(Logging::INFO, BRIGHT_GREEN) << "    | | //              ____  ____                   " <<ENDL;
    logger(Logging::INFO, BRIGHT_GREEN) << "    | |//_      __ /  ( _ _|(     |   |  " << ENDL;
    logger(Logging::INFO, BRIGHT_GREEN) << "    | / \\   //\\ ( //|  _  \\    |___|   " << ENDL;
    logger(Logging::INFO, BRIGHT_GREEN) << "    | |  \\ //__\\ //    |___||   |   | " << ENDL;
    logger(Logging::INFO, BRIGHT_GREEN) << "    | |   \\ / / \\      (_____)_ |  _|  / | |  | |       " <<ENDL;
    logger(Logging::INFO, BRIGHT_GREEN) << "    |_| v" << PROJECT_VERSION_LONG <<"|___/  |_|  |_|      "<< ENDL;
