...
bool core::on_idle() {
  if (!m_starter_message_showed) {
    logger(INFO) << ENDL << "**********************************************************************" << ENDL
      ...
      << "You can fasten this process by downloading a snapshot here: \"http://blocks.kwagsh.xyz/\" " << ENDL
      << "How to setup a blockchain file? Read here: \"http://blocks.kwagsh.xyz/readme.txt\" " << ENDL
      << ENDL
